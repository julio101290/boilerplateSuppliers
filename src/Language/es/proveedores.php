 <?php
    ...
    $proveedores["msg_delete"] = "El Registro en proveedores fue eliminado correctamente:";
    ...
    $sproveedores["fields"]["created_at"] = "Fecha de creacion";
    $proveedores["fields"]["updated_at"] = "Ultima modificacion";
    $proveedores["fields"]["deleted_at"] = "Fecha de eliminacion";

    $proveedores["fields"]["postalCode"] = "Código Postal";
    $proveedores["fields"]["razonSocial"] = "Razón Social";

    $proveedores["fields"]["formasDePago"] = "Forma de Pago";
    $proveedores["fields"]["seleccioneFormaDePago"] = "Seleccione la forma de pago";
    $proveedores["fields"]["metodoDePago"] = "Método de Pago";
    $proveedores["fields"]["seleccioneMetodoDePago"] = "Selecciono el Método de Pago";
    $proveedores["fields"]["usoCFDI"] = "Uso CFDI";
    $proveedores["fields"]["seleccioneUsoDelCFDI"] = "Seleccione el uso del CFDI";
    $proveedores["fields"]["regimenFiscal"] = "Régimen Fiscal";
    $proveedores["fields"]["seleccioneRegimenFiscal"] = "Seleccione Régimen Fiscal";
